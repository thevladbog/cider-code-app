...
export class ShiftService {
   ...
   * @throws ApiError
   */
  public static shiftControllerFindOne({ id }: { id: string }): CancelablePromise<IShiftFindOne> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/shift/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static shiftControllerRemove({ id }: { id: string }): CancelablePromise<IDeletedShift> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/shift/{id}',
      path: {
